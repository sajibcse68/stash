...
url: /products/stash/0.7.1/getting-started/
aliases:
  - /products/stash/0.7.1/
---
...
|--------------------------------------------------------------------------|-----------------------------------------------------------------------|--------------------|
| [0.7.1](https://github.com/appscode/stash/releases/tag/0.7.1) (uses CRD) | [User Guide](https://github.com/appscode/stash/tree/0.7.1/docs) | 1.7.x+             |
